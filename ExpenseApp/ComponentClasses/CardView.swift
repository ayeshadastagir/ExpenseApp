...
class CardView: UIView {
    ...
    private let titleLabel = Label(text: "", textColor: .white, font: .systemFont(ofSize: 20))
    let amountLabel = Label(text: "", font: .systemFont(ofSize: 35, weight: .semibold))
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            cardImage.widthAnchor.constraint(equalToConstant: 90.widthRatio),
            cardImage.heightAnchor.constraint(equalToConstant: 90.autoSized),
            ...
            amountLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 10.autoSized),
